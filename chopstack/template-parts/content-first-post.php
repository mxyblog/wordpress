...
<div class="post">
	<a href="<?php the_permalink(); ?>" rel="nofollow" class="post-cover-box post-cover-box-wide">
		<?php if ( has_post_thumbnail() ) : ?>
			<div style="background-image:url('<?php echo get_post_thumbnail();?>?imageView2/1/w/786/h/252/q/100')" class="post-cover"></div>
		<?php else : ?>

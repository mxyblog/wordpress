...
$settings           = array(
  ...
  'framework_title' => '<a style="color:#fff;text-decoration: none;" href="https://www.htm.fun/">完美主义者 HTM.FUN</a><small class="oldVer" data-vs="1.0.0 "style="color:#dc7575;margin-left:10px">Release 1.0.0</small>',
);
...
$options[]      = array(
  ...
  'fields'      => array(
        // twitter
        array(
            'id'      => 'plus_footer_twitter',
            'type'    => 'text',
            'title'   => 'twitter',
            'desc'    => '请设置twitter地址，请带上http://',
        ),
        // qq
        array(
            'id'      => 'plus_footer_qq',

...
<div id="comments" class="clearfix">
    ...
    <div class="respond-box">
        ...
        <div id="respond">
            ...
            <?php endif; ?>
            <?php if ( ! $user_ID ): ?>
            <p class="comment-note" style="color: #999;font-size: 14px;">
                人生在世，错别字在所难免，无需纠正。
            </p>
            <input required="required" type="text" name="author" id="author" placeholder="昵称orQQ"
            value="<?php echo $comment_author; ?>">
            <input required="required" type="text" name="email" id="email" placeholder="邮箱"
            value="<?php echo $comment_author_email; ?>">
            <input class="float-right" type="text" name="url" id="url" placeholder="网址（选填）"
            ...
            <p class="form-submit">
                <span id="cancel-comment-reply"><?php cancel_comment_reply_link('取消评论'); ?></span>

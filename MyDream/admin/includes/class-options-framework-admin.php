...
class Options_Framework_Admin {
     ...
     */
	 function options_page() { ?>
		...
		<h2><div class="dashicons dashicons-admin-settings"></div><?php echo esc_html( $menu['page_title'] ); ?><span class="version"><?php $my_theme = wp_get_theme(); echo "版本 " . $my_theme->get( 'Version' ); ?></span><span class="updated-date"><?php echo version; ?></span></h2>
